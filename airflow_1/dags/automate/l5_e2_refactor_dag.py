...
#
    @task()
    def find_riders_birthyear_2000(*args, **kwargs):
    ...
    @task
    def how_often_bike_is_ridden(*args, **kwargs):
        redshift_hook = PostgresHook("redshift")
    ...
    @task
    def count_number_of_stations_by_city(*args, **kwargs):
        redshift_hook = PostgresHook("redshift")
    ...
    find_riders_birthyear_2000 = find_riders_birthyear_2000()
    how_often_bike_is_ridden = how_often_bike_is_ridden()
    count_number_of_stations_by_city = count_number_of_stations_by_city()
    ...
    find_riders_birthyear_2000 >> create_oldest_task
    how_often_bike_is_ridden >> create_oldest_task
    count_number_of_stations_by_city >> create_oldest_task
